...
Input audio from the user --> ASR (Whisper) --> Uploading txt file in backend --> NLP (OpenAI) --> TTS (Edge-TTS) --> Uploading txt file in backend --> Generation of facial animations (Audio2Face and Audio2Emotion) --> Avatar Rendering (MetaHumans)
